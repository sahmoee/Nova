        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: Theme.Spacing.lg) {
                    ...
                    Text("Connect your own Real-Debrid account to resolve links to media you own or are authorized to access. Astra does not provide or index any content.")
                        .font(.appFont(17))
    ...
    private var unrestrictSection: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.md) {
            Text("Unrestrict a Link")
                .font(Theme.Font.sectionTitle())
                .foregroundStyle(Theme.Colors.textPrimary)
            Text("Paste a hoster link you're authorized to access. Astra resolves it through your account and adds it to your library.")
                .font(.appFont(20))
                .foregroundStyle(Theme.Colors.textSecondary)
