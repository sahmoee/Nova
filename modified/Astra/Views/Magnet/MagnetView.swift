...
struct MagnetView: View {
    ...
    private var inputSection: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.md) {
            Text("Paste a magnet link you own or are authorized to access. Astra sends it only to your Real-Debrid account.")
                .font(.appFont(20))
                .foregroundStyle(Theme.Colors.textSecondary)
            ...
            HStack(spacing: Theme.Spacing.sm) {
                TextField("magnet:?xt=urn:btih:…", text: $magnetText)
                    ...
                    .foregroundStyle(Theme.Colors.textPrimary)
                    // Keyboard return submits when the magnet is valid and confirmed.
