...
//  Astra
//
//  Lets the user point Astra at their own Cloudflare Worker for Claude-powered
//  search. Astra never stores an API key — the Worker the user deploys holds the
...
struct AISearchSettingsView: View {
    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading, spacing: Theme.Spacing.lg) {
                ...
                Text("Search for movies and shows using natural language, powered by Claude. For your security, Astra doesn't hold any AI keys. Instead, it calls a small Cloudflare Worker that you deploy and that keeps your key private on the server.")
                    .font(.appFont(19))
    ...
    private var workerInstructions: some View {
        VStack(alignment: .leading, spacing: Theme.Spacing.md) {
            ...
            Text("Your key lives only in your Worker's secrets and is never sent to or stored by Astra.")
                .font(.appFont(14))
