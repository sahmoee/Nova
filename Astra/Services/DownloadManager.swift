...
//  Astra
//
//  Downloads a directly-playable file (SMB, direct URL) to local storage for offline
//  viewing. Progress is published for the UI. Files live in Documents/Downloads keyed
//  by the item's id.
//
