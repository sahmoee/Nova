...
files = [
    ("LibraryFolderStore.swift", fileref_ls, "LibraryStore.swift"),
    ("LibraryFoldersView.swift", psv_ref, "PlayerSettingsView.swift"),
    ("LiveTVSourceStore.swift", fileref_ls, "LibraryStore.swift"),
...
if changed: open(pbx,"w").write(s); print("Registered new files")
