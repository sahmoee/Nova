/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6aab7fcc9948e4ea70adc8c39b04ed62)
// Runtime types generated with workerd@1.20260730.1 2026-08-01 
interface __BaseEnv_Env {
	SERVICE_NAME: "nova-ai-worker";
	MODEL: "claude-sonnet-4-6";
	ALLOWED_ORIGIN: "";
	SHARE_STORE: DurableObjectNamespace<import("./src/index").ShareStore>;
	RATE_LIMITER: DurableObjectNamespace<import("./src/index").RateLimiter>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ShareStore" | "RateLimiter";
	}
