...
struct DiscoverView: View {
    ...
    private var hint: some View {
        Text("Search for a movie or show to find streams from your installed addons.")
            .font(.appFont(22))
            // Contrast: this is primary guidance, not a footnote — tertiary (42%) is too dim.
            .foregroundStyle(Theme.Colors.textSecondary)
    ...
    private var noKeyState: some View {
        EmptyStateView(
            ...
            message: "Search needs a free TMDB API key. Add one in Settings ▸ Metadata & Accounts, or drop a NovaConfig.json next to the app."
        )
        .frame(height: 400)
    }
