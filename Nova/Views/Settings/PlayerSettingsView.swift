        ...
        ScrollView {
            VStack(alignment: .leading, spacing: Theme.Spacing.lg) {
                ...
                Text("Built-in Player")
                    ...
                    .foregroundStyle(Theme.Colors.textPrimary)
                Text("How video plays inside Nova. Automatic picks the best engine for each file.")
                    .font(.appFont(16))
                ...
                Text("External Player")
                    .font(Theme.Font.sectionTitle())
                    .foregroundStyle(Theme.Colors.textPrimary)
                Text("Hand video to another app you have installed. Nova opens the stream there instead of playing it in-app.")
                    .font(.appFont(16))
                    .foregroundStyle(Theme.Colors.textSecondary)
                ...
                Text("External players are opened by their app's link. If an app isn't installed, Nova will offer to play in-app instead.")
                    .font(.appFont(14))
