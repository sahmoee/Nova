        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: Theme.Spacing.lg) {
                    ...
                    block(
                        title: "What Nova is",
                        body: "Nova is a personal media player for content you own, control, or are authorized to access. It does not include a content catalog, search engine, scraper, or any index of media sources."
                    )
                    ...
                    block(
                        title: "AI features",
                        body: "AI search and AI shelf and playlist building are optional and off until you add your own AI Worker URL. When you use them, the text you type and, for library search, the titles in your library are sent to the Worker you deployed, which forwards them to the Anthropic API to generate suggestions. Nova does not run this service; you do. If you never configure a Worker, no data is sent for AI, and AI library search falls back to a local match on your device. You can stop all AI data sharing at any time by removing the Worker URL in Settings."
                    )
                    ...
                    block(
                        ...
                        body: "Nova does not bypass DRM, does not suggest sources, and does not help locate copyrighted material. It is a player, not a finder."
                    )
                    ...
                    VStack(alignment: .leading, spacing: Theme.Spacing.sm) {
                        Text("What Each Source Can Do")
                            ...
                            .foregroundStyle(Theme.Colors.textPrimary)
                        Text("Nova only talks to the services you set up. Here is exactly what each one is used for.")
                            .font(.appFont(18))
                        ...
                        permission(icon: "arrow.down.circle", source: "Real-Debrid",
                                   detail: "Resolves links through your own account. Nova never sees your password, only the token you authorize.")
                    ...
                    // LGPL) in-app keeps Nova compliant with their terms.
                    VStack(alignment: .leading, spacing: Theme.Spacing.sm) {
                        Text("Open-Source Acknowledgements")
                            .font(.appFont(28, weight: .bold))
                            .foregroundStyle(Theme.Colors.textPrimary)
                        Text("Nova is built with the following open-source components. Thank you to their authors.")
                            .font(.appFont(20))
                            .foregroundStyle(Theme.Colors.textSecondary)
