...
//  Nova
//
//  The set of players Nova can hand a stream to. Two kinds:
//
//  Built-in players run inside Nova. On Apple platforms only two engines can be
...
//
//  External players are separate apps the user has installed. Nova hands them the
...
/// A player that runs inside Nova. Each case maps to one of the two embeddable
...
/// A third-party player app Nova can hand a stream to (iOS only). Each builds a
