...
struct UnifiedQAProfile {
    ...
    static let nova = [
        ...
        item("library", "Library", "Library identity", "Watch progress and identity deduplicate across sources."),
        item("library-grid", "Library", "Centered poster grid", "All columns remain inside symmetric edge insets at every iPhone and iPad width."),
        item("history-hero", "Library", "Viewing-history hero", "The compact hero stays fully visible and rotates only through current or recently watched titles."),
        item("tracker-rails", "Library", "Tracker rails", "Currently Watching, TV Watchlist, Movie Watchlist, and imported Collection remain separate and open the correct title."),
        ...
        item("smb", "Library", "SMB folder browser", "Authentication, browsing, selection, reconnect, and library ingestion work."),
