...
/// View intervals in Instruments under the com.nova.app subsystem.
enum Signposts {
    static let shelf  = OSSignposter(subsystem: "com.nova.app", category: "shelf")
    static let stream = OSSignposter(subsystem: "com.nova.app", category: "stream")
