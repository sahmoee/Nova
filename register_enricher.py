...
files = [("LibraryEnricher.swift", fileref_ls, "LibraryStore.swift"),
         ("LibraryEnrichView.swift", psv_ref, "PlayerSettingsView.swift")]
changed=False
...
if changed: open(pbx,"w").write(s); print("Registered enricher files")
