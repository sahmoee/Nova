...
struct LibraryView: View {
    ...
    /// Base filters, plus the SMB tab when the user has chosen to separate it.
    ...
    private var displayedItems: [MediaItem] {
        ...
        // When the SMB tab is enabled, keep SMB items out of the other tabs so
        // network content lives in one place.
