...
//  FrameTV
//
//  Shown once on first launch. Sets clear expectations that FrameTV is a player and
                ...
                VStack(alignment: .leading, spacing: Theme.Spacing.lg) {
                    ...
                    VStack(alignment: .leading, spacing: Theme.Spacing.md) {
                        point(icon: "person.crop.circle",
                              text: "FrameTV plays media you own, control, or are authorized to access.")
                        point(icon: "xmark.circle",
                              text: "FrameTV does not include, sell, host, index, or provide any video content.")
                    ...
                    Text("By continuing you confirm you will only use FrameTV with media you are authorized to access.")
                        .font(.appFont(15))
