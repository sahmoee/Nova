...
private struct LibraryEnrichContent: View {
        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: Theme.Spacing.lg) {
                    ...
                    optionCard(title: "Fetch Images",
                               subtitle: "Find posters and backdrops for items that are missing artwork.",
                               systemImage: "photo.on.rectangle.angled", isOn: $fetchImages)

                    optionCard(title: "Clean Up Titles",
                               subtitle: "Turn names like \"WALL-E 2008 1080p\" into \"WALL-E\".",
                               systemImage: "textformat", isOn: $cleanTitles)

                    optionCard(title: "Use AI",
                               ...
                               systemImage: "sparkles", isOn: $useAI)
                    ...
                    if enricher.isRunning {
                        ...
                        Label(summary, systemImage: "checkmark.circle.fill")
                            .font(.appFont(15, weight: .medium)).foregroundStyle(Theme.Colors.accent)
                    }
    ...
    private func optionCard(title: String, subtitle: String, systemImage: String, isOn: Binding<Bool>) -> some View {
        HStack(spacing: Theme.Spacing.md) {
            Image(systemName: systemImage).font(.appFont(22)).foregroundStyle(Theme.Colors.accent).frame(width: 34)
            VStack(alignment: .leading, spacing: 3) {
                Text(title).font(.appFont(17, weight: .semibold)).foregroundStyle(Theme.Colors.textPrimary)
                Text(subtitle).font(.appFont(14)).foregroundStyle(Theme.Colors.textTertiary)
            }
            Spacer()
