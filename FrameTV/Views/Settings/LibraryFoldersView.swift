...
struct LibraryFoldersView: View {
    ...
    var body: some View {
        LibraryFoldersContent(store: env.libraryFolders)
    }
}
        ...
        ZStack {
            ...
            ScrollView {
                VStack(alignment: .leading, spacing: Theme.Spacing.lg) {
                    ...
                    FocusableButton(title: "Add Folder", systemImage: "plus", prominent: true) {
                        showAdd = true
                    }
        ...
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Add") {
                        if let id = selectedShareID {
                            onAdd(id, displayName.isEmpty ? "Folder" : displayName, path)
                        }
                    }
