...
//  FrameTV
//
//  The set of players FrameTV can hand a stream to. Two kinds:
//
//  Built-in players run inside FrameTV. On Apple platforms only two engines can be
...
//
//  External players are separate apps the user has installed. FrameTV hands them the
...
/// A player that runs inside FrameTV. Each case maps to one of the two embeddable
...
/// A third-party player app FrameTV can hand a stream to (iOS only). Each builds a
