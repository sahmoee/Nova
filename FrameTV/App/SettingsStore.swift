...
final class SettingsStore: ObservableObject {
    ...
    /// When on, the Library shows a dedicated "Network (SMB)" tab that lists items
    /// coming from SMB shares separately from the rest of the library.
    ...
    /// An in-app text-size multiplier (1.0 = normal) so users can enlarge FrameTV's
