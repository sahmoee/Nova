...
//  Apple TV home screen when Nova is the top row, and deep-links straight into the
...
final class TopShelfProvider: NSObject, TVTopShelfContentProvider {
    ...
    // Stable Astra App Group retained so the renamed app and extension keep the
    // same shared container across an in-place update.
